...
class MoneyTransferWorkflow:
    ...
    async def transfer(self, request: TransferRequest) -> str:
        """TODO: Implement workflow with versioning and manual retry capability"""
        ...
        try:
            ...
            # TODO: Use _execute_with_manual_retry() to call withdraw activity
            
            # Step 2: Wait for approval
            await workflow.wait_condition(lambda: self.approved)
            
            # Step 3: Deposit to target account
            # TODO: Use _execute_with_manual_retry() to call deposit activity
